...
<head>
    ...
    <title>MD/MS Admission 2025 – NEET PG Seats, Fees, Top Colleges & Counselling</title>
<meta name="description" content="Apply for MD/MS Admission 2025 through NEET PG. Explore NMC-approved colleges, seat matrix, fee structure, counselling dates, and expert admission support. Book your seat now.">
<meta name="keywords" content="MD/MS Admission 2025, NEET PG Counselling, PG Medical Courses, MD Admission 2025, MS Admission 2025, Top MD/MS Colleges India, NMC Approved PG Colleges, PG Medical Seats 2025, MD MS without donation, PG Medical Admission Help">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-3 col-sm-4 top-header-box">
                    <a href="{{url('/')}}">
                        <img src="{{ asset('Bano-Doctor-Logo.png')}}" width="120" alt="Bano Doctor - Top Medical Consultant" style="height:70px;">
                    </a>
                </div>
    ...
    <section class="landing-page-hero-section">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 mb-5 mb-lg-0 margin-50">
                    <div class="hero-content">
                        <h1 data-aos="fade-up">Begin Your Medical Journey with India's Top MD/MS Programs</h1>
                    ...
                    <div class="testimonial-card">
                        ...
                        <div class="testimonial-author">
                            ...
                            <div>
                                ...
                                <small>MD/MS Student, Mumbai</small>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-card">
                        ...
                        <div class="testimonial-author">
                            ...
                            <div>
                                ...
                                <small>MD/MS Student, Delhi</small>
                            </div>
                        </div>
                    </div>
                    <div class="testimonial-card">
                        ...
                        <div class="testimonial-author">
                            ...
                            <div>
                                ...
                                <small>MD/MS Student, Bangalore</small>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <p class="mt-3">Your trusted partner for medical admissions in India. We provide end-to-end guidance for MD/MS admissions through genuine processes.</p>
