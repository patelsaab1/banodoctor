        ...
        <div class="container py-2">
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('faq-create', request()->page_id) }}" method="post" enctype="multipart/form-data" id="faqForm">
                                @csrf
                                    ...
                                    <div class="col-12">
                                        <select class="form-control" name="page_id">
                                            @foreach($pageList as $p)
                                             ...
                                             <option value="{{ $p->id }}" {{ $p->id == request()->page_id ? 'selected' : '' }}>{{ $p->title }}</option>
