...
/*$(window).scroll(function(){
  ...
  if (scroll >= 100) sticky.addClass('fixed');
      ...
      var formStick=$('#form-sticky-sidebar');
      
  var ContentHeight=$('#content-page-section').height();
  
  
  if (scroll >=1500 && scroll <=ContentHeight) formStick.addClass('form-sidebar-fixed');
  else formStick.removeClass('form-sidebar-fixed');
